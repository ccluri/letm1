...
l_reg_fn = '100_regular_20Hz_20_Letm1.npz'

# 10 Hz, 10AP
c_reg_10 = '100_regular_10Hz_7_Control.npz'
l_reg_10 = '100_regular_10Hz_20_Letm1.npz'

# 600 AP, 10Hz
c_reg_long = '100_regular_10Hz_7_Control_600AP.npz'
l_reg_long = '100_regular_10Hz_20_Letm1_600AP.npz'

c1_poi_fn = str(seed) + '_100_poi_1Hz_7_Control.npz'
l1_poi_fn = str(seed) + '_100_poi_1Hz_20_Letm1.npz'

c2_poi_fn = str(seed) + '_100_poi_2Hz_7_Control.npz'
l2_poi_fn = str(seed) + '_100_poi_2Hz_20_Letm1.npz'

c5_poi_fn = str(seed) + '_100_poi_5Hz_7_Control.npz'
l5_poi_fn = str(seed) + '_100_poi_5Hz_20_Letm1.npz'

c10_poi_fn = str(seed) + '_100_poi_10Hz_7_Control.npz'
l10_poi_fn = str(seed) + '_100_poi_10Hz_20_Letm1.npz'

c20_poi_fn = str(seed) + '_100_poi_20Hz_7_Control.npz'
l20_poi_fn = str(seed) + '_100_poi_20Hz_20_Letm1.npz'

c50_poi_fn = str(seed) + '_100_poi_50Hz_7_Control.npz'
l50_poi_fn = str(seed) + '_100_poi_50Hz_20_Letm1.npz'
...
axd['A'].plot(l_reg['tt'], l_reg['ca_mat'], c='#FF0A6C', lw=1)
...
# axd['B'].plot(l_reg_l['tt'], l_reg_l['atp'], c='#FF0A6C', lw=1)
...
axd['B'].plot(l_reg['tt'], l_reg['atp'], c='#FF0A6C', lw=1)
...
# axd['B'].plot(l_reg_t['tt'], l_reg_t['atp'], c='#FF0A6C', lw=1)
...
axd['X'].plot(l2_poi['tt'], l2_poi['atp'], c='#FF0A6C', lw=1)
...
axd['Y'].plot(l2_poi['tt'], l2_poi['atp'], c='#FF0A6C', lw=1)
...
print(vals_l, 'letm1kd atp during')
axd['R'].plot(freqs, vals_c, c='k', marker='.', label='Control')
axd['R'].plot(freqs, vals_l, c='#FF0A6C', marker='.', label='Letm1 KD')
...
freqs = [0, 1, 2, 5, 10, 20, 50]
print(vals_c, 'control pyr during')
print(vals_l, 'letm1kd pyr during')
axd['T'].plot(freqs, vals_c, c='k', marker='.', label='Control')
axd['T'].plot(freqs, vals_l, c='#FF0A6C', marker='.', label='Letm1 KD')
axd['T'].set_ylabel('Pyruvate (A.U.)')
axd['T'].set_xlabel('Frequency (Hz)')
axd['T'].legend(ncols=2, frameon=False, loc='upper center')
...
print(vals_l, 'letm1kd ca_mat during')
...
print(vals_l, 'letm1kd atp after')
axd['U'].plot(freqs, vals_c, c='k', marker='.', label='Control')
axd['U'].plot(freqs, vals_l, c='#FF0A6C', marker='.', label='Letm1 KD')
...
for xx, yy, zz in zip(c_poi, l_poi, l_spike_idx):
    ...
    vals_l.append(np.mean(yy['pyr'][zz:first_ten_idx+zz]))
freqs = [0, 1, 2, 5, 10, 20, 50]
print(vals_c, 'control pyr after')
print(vals_l, 'letm1kd pyr after')
axd['V'].plot(freqs, vals_c, c='k', marker='.', label='Control')
axd['V'].plot(freqs, vals_l, c='#FF0A6C', marker='.', label='Letm1 KD')
axd['V'].set_ylabel('Pyruvate (A.U.)')
axd['V'].set_xlabel('Frequency (Hz)')
axd['V'].legend(ncols=2, frameon=False, loc='upper center')
...
print(vals_l, 'letm1kd ca_mat after')
...
for quant in ['ca_mat', 'pyr', 'atp']:
    ...
    print(vals_l, 'letm1kd 101 '+quant)
